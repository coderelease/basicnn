...
setup(
    ...
    author="Yang Xiang",  # 作者相关信息
    author_email='btk@qq.com',
    url='https://github.com/coderelease',

    # 指定包信息，还可以用find_packages()函数  # find_packages(where="./", include=["basicnn*"]),
    # packages=["basicnn",
    #           "basicnn.image_video_utils"],
    packages=find_packages(where=".", include=["basicnn*"]),
...
twine upload --repository basicnn@testpypi dist/*
pip install -i https://test.pypi.org/simple/ -U basicnn

twine upload --repository basicnn@pypi dist/*
"""
